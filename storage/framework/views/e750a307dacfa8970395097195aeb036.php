...
<div id="editServiceModal" class="artwork-popup">
    <div class="artwork-popup-content">
        ...
        <form id="editServiceForm" method="POST"
            action="<?php echo e(route('commission.update', ['id'=>0])); ?>"
    ...
    <div class="artwork-popup-content" style="padding:20px;">
        ...
        <div style="display:flex;gap:10px;margin-top:10px;">
            <form id="deleteServiceForm" method="POST"
                action="<?php echo e(route('commission.delete', ['id'=>0])); ?>">
...
<?php /**PATH C:\Users\User\Documents\ade\aneris\resources\views/dashboards/service.blade.php ENDPATH**/ ?>