...
<form id="login" class="active" method="POST" action="<?php echo e(route('auth.login')); ?>">
<?php echo csrf_field(); ?>
...
<form id="register" method="POST" action="<?php echo e(route('auth.register')); ?>">
<?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\hana fathia\Documents\aneris\resources\views/auth/auth.blade.php ENDPATH**/ ?>