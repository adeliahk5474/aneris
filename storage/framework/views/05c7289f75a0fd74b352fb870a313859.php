...
<form action="<?php echo e(route('upload.artwork')); ?>"
    ...
    <div class="mb-3">
        ...
        <input type="file" name="image" id="artworkImageInput"
               class="form-control mt-1" required>

        <img id="artworkPreview"
             style="width:100%; margin-top:10px; display:none; border-radius:10px;">
    </div>
...
<form action="<?php echo e(route('upload.commission')); ?>"
      method="POST" enctype="multipart/form-data" class="space-y-3">
    <?php echo csrf_field(); ?>
    ...
    <div class="mb-3">
        ...
        <input type="file" name="image" id="commissionImageInput"
               class="form-control mt-1" required>

        <img id="commissionPreview"
             style="width:100%; margin-top:10px; display:none; border-radius:10px;">
    </div>
...
`;
    ...
    initPreview('artworkImageInput', 'artworkPreview');
    ...
    if (role === "artist" && tabCommission) {
        tabCommission.onclick = () => {
            ...
            initPreview('commissionImageInput', 'commissionPreview');
        };
    }
</script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Documents\ade\aneris\resources\views/page/popup.blade.php ENDPATH**/ ?>